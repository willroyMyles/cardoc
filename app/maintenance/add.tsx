...
const TYPES = Object.entries(MAINTENANCE_TYPE_LABELS) as [
  MaintenanceType,
  string,
][];
...
export default function AddMaintenanceScreen() {
  ...
  const handleSave = () => {
    if (!vehicleId) {
      Alert.alert("Select Vehicle", "Please select a vehicle first.");
      return;
    }
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: c.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {/* Mileage */}
        <Label text="Mileage at Service" c={c} />
        <TextInput
          style={[
            styles.input,
            { color: c.text, borderColor: c.border, backgroundColor: c.card },
        ...
        {/* Workshop */}
        <Label text="Workshop / Mechanic" c={c} />
        <TextInput
          style={[
            styles.input,
            { color: c.text, borderColor: c.border, backgroundColor: c.card },
